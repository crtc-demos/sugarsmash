...
ld65 --config none.cfg -S 0x8000 tiles.o -o tiles

6502-gcc -mmach=bbcmaster -mcpu=65C02 -Os render.c -Wl,-D,__STACKTOP__=0x40ff -o render -save-temps -Wl,-m,render.map
...
echo "binary size: $BINSIZE / $(( 0x4100 - 0xe00 ))"
